        ...
        try:
            ...
            if torch.cuda.is_available():
                ...
                for i in range(cap.gpu_count):
                    ...
                    cap.free_vram_gb += (props.total_memory - torch.cuda.memory_allocated(i)) / (1024**3)
...
def recommend_models(
    ...
    # 已知常用模型及显存需求
    known_models = [
        {"model_id": "Qwen/Qwen2.5-0.5B-Instruct", "name": "Qwen2.5-0.5B", "params": 0.5, "vram_gb": 1.5,
         "description": "超轻量模型，适合CPU或低显存GPU", "tags": ["轻量", "CPU可运行", "入门"]},
        {"model_id": "Qwen/Qwen2.5-1.5B-Instruct", "name": "Qwen2.5-1.5B", "params": 1.5, "vram_gb": 4.0,
         "description": "轻量级模型，最低配置可运行", "tags": ["轻量", "已验证", "推荐"]},
        {"model_id": "Qwen/Qwen2.5-3B-Instruct", "name": "Qwen2.5-3B", "params": 3.0, "vram_gb": 8.0,
         "description": "小模型，适合中等配置GPU", "tags": ["实用", "多任务"]},
        {"model_id": "Qwen/Qwen2.5-7B-Instruct", "name": "Qwen2.5-7B", "params": 7.0, "vram_gb": 16.0,
         "description": "主流开源模型，性能和资源平衡", "tags": ["主流", "高性能"]},
        {"model_id": "meta-llama/Llama-3.2-1B-Instruct", "name": "Llama-3.2-1B", "params": 1.0, "vram_gb": 3.0,
         "description": "Meta轻量级模型", "tags": ["轻量", "Meta"]},
        {"model_id": "meta-llama/Llama-3.2-3B-Instruct", "name": "Llama-3.2-3B", "params": 3.0, "vram_gb": 8.0,
         "description": "Meta小型模型", "tags": ["实用", "Meta"]},
        {"model_id": "meta-llama/Llama-3-8B-Instruct", "name": "Llama-3-8B", "params": 8.0, "vram_gb": 18.0,
         "description": "Meta 8B模型，需较高配置", "tags": ["主流", "Meta"]},
        {"model_id": "google/gemma-2-2b-it", "name": "Gemma-2-2B", "params": 2.0, "vram_gb": 5.0,
         "description": "Google轻量模型", "tags": ["轻量", "Google"]},
        {"model_id": "microsoft/Phi-3.5-mini-instruct", "name": "Phi-3.5-mini", "params": 3.8, "vram_gb": 9.0,
         "description": "微软小模型，推理能力强", "tags": ["实用", "Microsoft"]},
        {"model_id": "deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B", "name": "DeepSeek-R1-1.5B", "params": 1.5, "vram_gb": 4.0,
         "description": "DeepSeek推理蒸馏版，轻量", "tags": ["推理", "轻量"]},
        {"model_id": "deepseek-ai/DeepSeek-R1-Distill-Qwen-7B", "name": "DeepSeek-R1-7B", "params": 7.0, "vram_gb": 16.0,
         "description": "DeepSeek推理蒸馏版，7B", "tags": ["推理", "主流"]},
        {"model_id": "mistralai/Mistral-7B-Instruct-v0.3", "name": "Mistral-7B-v0.3", "params": 7.0, "vram_gb": 16.0,
         "description": "Mistral 7B，经典开源模型", "tags": ["主流", "Mistral"]},
    ]
    ...
    if popular_models:
        for pm in popular_models:
            ...
            if vram_est > 0:
                ...
                entry = {
                    "model_id": model_id,
                    "name": (author + "/" + model_id.split("/")[-1]) if "/" in model_id else model_id,
                    "params": param_est,
                    "vram_gb": vram_est,
    ...
    return {
        ...
        "summary": {
            ...
            "can_run_7b": available_vram >= 14 or (not capability.has_cuda and capability.ram_free_gb > 20),
            "can_run_3b": available_vram >= 6 or (not capability.has_cuda and capability.ram_free_gb > 10),
...
def _estimate_params_from_name(name: str) -> int:
    ...
    name = name.lower()
    patterns = [
        ("405b", 405_000_000_000), ("180b", 180_000_000_000),
        ("72b", 72_000_000_000), ("70b", 70_000_000_000),
        ("65b", 65_000_000_000), ("40b", 40_000_000_000),
        ("34b", 34_000_000_000), ("20b", 20_000_000_000),
        ("14b", 14_000_000_000), ("13b", 13_000_000_000),
        ("11b", 11_000_000_000), ("9.4b", 9_400_000_000),
        ("9b", 9_000_000_000), ("8b", 8_000_000_000),
        ("7b", 7_000_000_000), ("3.8b", 3_800_000_000),
        ("3b", 3_000_000_000), ("2.6b", 2_600_000_000),
        ("2b", 2_000_000_000), ("1.5b", 1_500_000_000),
        ("1b", 1_000_000_000), ("0.5b", 500_000_000),
    ]
