...
| 文档 | 说明 |
|------|------|
| [ARCHITECTURE.md](./ARCHITECTURE.md) | 系统设计：模块划分、数据流、调度策略、部署拓扑 |
| [API.md](./API.md) | 接口文档：REST API、gRPC API、CLI 命令 |
| [DEPLOYMENT.md](./DEPLOYMENT.md) | 部署文档：环境要求、本地与生产部署、监控 |
| [TESTING.md](./TESTING.md) | 测试文档：测试策略、跑测指南、覆盖率、gRPC 测试 |
